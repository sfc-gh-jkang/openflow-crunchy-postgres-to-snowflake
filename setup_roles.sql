...
GRANT ALL PRIVILEGES ON ALL SCHEMAS IN DATABASE OPENFLOW TO ROLE OPENFLOW_ADMIN;
USE SCHEMA OPENFLOW.PUBLIC;

-- Grant role to current user and ACCOUNTADMIN
GRANT ROLE OPENFLOW_ADMIN TO ROLE ACCOUNTADMIN;
SET myuser = (SELECT CURRENT_USER());
GRANT ROLE OPENFLOW_ADMIN TO USER IDENTIFIER($myuser);
